...
},{"./utils":"../../node_modules/axios/lib/utils.js","./helpers/normalizeHeaderName":"../../node_modules/axios/lib/helpers/normalizeHeaderName.js","./adapters/xhr":"../../node_modules/axios/lib/adapters/xhr.js","./adapters/http":"../../node_modules/axios/lib/adapters/xhr.js","process":"../../../../../../../../../../../home/mostafa/.nvm/versions/node/v18.1.0/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../../node_modules/axios/lib/core/InterceptorManager.js":[function(require,module,exports) {
'use strict';
...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div calss=\"alert alert--".concat(type, "\">").concat(msg, "</div>");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = data === 'password' ? 'http://127.0.0.1:3000/api/v1/users/updateMyPassword' : 'http://127.0.0.1:3000/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_51LOybiFs7r59FF3LTcHzUaTvxcRdbiFAF50QAoPXIOrTU5mKx6KwLI8wVDk27kiT1xn28NccgYI72s2WmF4Lcz0E00T5hgr1GV');
...
var bookTourBtn = document.querySelector('#book-tour'); // DELEGATION
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 14:
            ...
            (0, _alerts.showAlert)('error', _context.t0.response.data.status);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "41675" + '/');
...
},{}]},{},["../../../../../../../../../../../home/mostafa/.nvm/versions/node/v18.1.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
